    ...
    <div className='bg-gradient-to-b w-full text-gray-400 from-black to-gray-800' name='Contact'>
        <div className='flex flex-col p-4 justify-center pt-28 max-w-screen-lg mx-auto'>
            ...
            <div className='lg:hidden flex mx-auto pb-12 gap-4 max-w-screen-lg'>
                <a target='_blank' href="https://www.linkedin.com/in/shobhnik-wadhwa-9986b6203/" className='cursor-pointer hover:scale-110 duration-200 text-blue-500'><FaLinkedin/></a>
                <a  target='_blank' href="https://github.com/Shobhnik13" className='cursor-pointer hover:scale-110 duration-200 text-gray-500'><FaGithub/></a>  
                <a target='_blank' href="https://twitter.com/Shobhnik__13" className='cursor-pointer hover:scale-110 duration-200 text-blue-500'><FaTwitter/></a>
                <a  target='_blank' href="https://leetcode.com/Shobhnik_1326/" className='cursor-pointer hover:scale-110 duration-200 text-yellow-600'><SiLeetcode/></a>
                <a target='_blank' href="mailto:shobhnikw@gmai.com" className='cursor-pointer hover:scale-110 duration-200 text-red-400'><MdOutlineMail size={40}/></a>
            </div> 
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/0c1384f7-f938-447f-8959-930f15d04b25" method='POST' className='flex flex-col w-[200px] md:w-1/2'>
